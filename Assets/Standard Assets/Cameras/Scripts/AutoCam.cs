        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            else
            {
                ...
                if (m_SpinTurnLimit > 0)
                {
                    ...
                    var desiredTurnAmount = Mathf.InverseLerp(m_SpinTurnLimit *.75f, m_SpinTurnLimit, targetSpinSpeed);//MMP //Mathf.InverseLerp(m_SpinTurnLimit, m_SpinTurnLimit*0.75f, targetSpinSpeed);
